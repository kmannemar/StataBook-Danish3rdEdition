...
esttab using ktabel1, cell(colpct(fmt(%2,1f))) rtf unstack noobs replace collabels(none) nonumber nomtitle
...
ytitle("Marginal effect of aid on growth""(Difference between heavy and light receivers)") ///
title("") /// fjerner den overordnede titel
...
note("Noter: 95% konfidensinterval. De lodrette linjer repræsenterer hhv. 25. og 75. percentil", ///
